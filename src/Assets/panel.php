...
$sql_total_t = 0;
$__sql = array();
if (isset($__containers['sqlLog'])) {
    $__sql = $__containers['sqlLog'];
}
...
/* viewData */
$__view = array();
if (isset($__containers['viewData'])) {
    $__view = $__containers['viewData'];
    unset($__containers['viewData']);
}

/* routeData */
$__route = array();
if (isset($__containers['routeData'])) {
    $__route = $__containers['routeData'];
...
<div class="phpdebugbar">
    ...
    <div class="phpdebugbar-header">
        ...
        <!-- GLOBAL INFORMATION (version, memory usage, time) -->
    ...
    <div class="phpdebugbar-body">
        ...
        <div class="phpdebugbar-panel js-request-data">
            <dl class="phpdebugbar-widgets-kvlist phpdebugbar-widgets-varlist">
                ...
                <dd class="phpdebugbar-widgets-value">
                    <?= isset($_SERVER['SERVER_PORT']) ? intval($_SERVER['SERVER_PORT']) : "null" ?>
                </dd>

                <dt class="phpdebugbar-widgets-key"><span title="Method">Method:</span></dt>
                <dd class="phpdebugbar-widgets-value">
                    <?= mb_strtoupper(isset($_SERVER['REQUEST_METHOD']) ? $_SERVER['REQUEST_METHOD'] : 'GET') ?>
                </dd>
